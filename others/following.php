...
?>
<div class="box">
<h3>People who <?php echo $profile_name;?> is Following</h3>
<div class="userdata">
	<div class="followbox">
	<?php

	//checking whether current user follows them or not
	$follow_check="select * from follow WHERE user_id='$profile_id' ";
	$user_sql=mysql_query($follow_check);
	$count=mysql_num_rows($user_sql);
	if($count > 0){
	echo $profile_name." is Following : ".$count."<br><br>";
	?>
	<table>
	<?php
	...
	<?php
		...
		echo $profile_name." is not following any one";
	}
	?>
	</div>
</div>
